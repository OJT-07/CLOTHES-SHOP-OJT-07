    ...
    dataRender.forEach((item) => {
      ...
      listItem.innerHTML = `
            <div class="product__item">
                ...
                <a href="../Product/productDetail.html?id=${item._id}"><img src="${item.image}" style="height: 260px; width: 260px;"/></a>
...
function handleCheckboxClickPrice(checkboxId) {
  // Uncheck all checkboxes
  document
    .querySelectorAll('.shop__sidebar__price input[type="checkbox"]')
    .forEach(function (checkbox) {
      checkbox.checked = false;
    });
