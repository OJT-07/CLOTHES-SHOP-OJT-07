...
document.addEventListener("DOMContentLoaded", () => {
    ...
    searchForm.addEventListener("submit", (event) => {
        ...
        window.location.assign(`/Customer/Product/productList.html?search=${searchInput}`);
    });

    renderData();
});

// JavaScript function to handle checkbox clicks
function handleCheckboxClick(checkboxId, category) {
    ...
    // Call the filterProducts function with the category
    filterProducts(category);
}

// Example filterProducts function (replace this with your actual implementation)
