...
const renderData = async () => {
    ...
    const searchProducts = async () => {
        ...
        let paramsSearch = new URL(document.location).searchParams;
        let name = paramsSearch.get("name");

        if (name === null) {
            dataRenderSearch = data.products;
        } else {
            var filterDataSearch = await data.products.filter(
                (item) => item.name === name
            );
            dataRenderSearch = filterDataSearch;
        }
