...
const data = await response.json();
    ...
    <div class="d-flex justify-content-between align-items-center py-3">
        <h2 class="h5 mb-0">
            <a href="#" class="text-muted"></a> Order #16123222</h2>
    </div>
                ...
                <div class="card-body">
                    <div class="mb-3 d-flex justify-content-between">
                        <div>
                            ...
                            <span class="me-3">Payment on delivery</span>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <p>Payment on delivery <br> Total: $169,98 <span class="badge bg-success rounded-pill">PAID</span></p>
                        </div>
                        <div class="col-lg-6">
